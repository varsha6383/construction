    ...
    <div className="bg-white font-primary">
      ...
      <div className="hidden xl:block">
        <div className="bg-[#0c3c3f] text-center text-white py-[10%]">
          <h1 className="text-[3vw] font-bold mb-2 font-primary">Privacy Policy</h1>
        </div>
      ...
      <div className="hidden lg:block xl:hidden">
        <div className="bg-[#0c3c3f] text-center text-white py-[10%]">
          <h1 className="text-[4.5vw] font-bold font-primary mb-2">Privacy Policy</h1>
        </div>
      ...
      <div className="hidden sm:block lg:hidden">
        <div className="bg-[#0c3c3f] text-center text-white py-[12%]">
          <h1 className="text-[5vw] font-primary font-bold mb-2">Privacy Policy</h1>
        </div>

        <div className="max-w-4xl mx-auto px-[8%] py-[8%] text-[95%] leading-[165%] space-y-[5%]">
         <div>
            <h2 className="font-bold text-[4vw] font-primary mb-[1%] text-[#305658]">1. Introduction</h2>
            <p className="text-[2.7vw] pt-[3%] font-sencondary text-[#305658]">
              <span className="font-semibold font-sencondary">SRI VELAN CONSTRUCTION</span> is committed to protecting the privacy of our clients and website users. This policy outlines how we collect, use, and safeguard your information.
            </p>
          </div>

          <div>
            <h2 className="font-bold text-[4vw] font-primary mb-[1%] text-[#305658]">2. Information Collection</h2>
            <ul className="list-disc ml-[4%] space-y-[0.8%]">
              <li className="text-[2.7vw] font-sencondary text-[#305658] ">Name, contact number, email address, and address.</li>
              <li className="text-[2.7vw] font-sencondary text-[#305658]">Project details, requirements, and preferences.</li>
            </ul>
          </div>

          <div>
            <h2 className="font-bold text-[4vw] font-primary mb-[1%] text-[#305658]">3. Use of Information</h2>
            <ul className="list-disc ml-[4%] space-y-[0.8%]">
              <li className="text-[2.7vw] font-sencondary text-[#305658] ">Provide and improve our construction services.</li>
              <li className="text-[2.7vw] font-sencondary text-[#305658]">Respond to inquiries and service requests.</li>
              <li className="text-[2.7vw] font-sencondary text-[#305658]">Communicate project updates, billing, and contractual obligations.</li>
            </ul>
          </div>

          <div>
            <h2 className="font-bold text-[4vw] font-primary mb-[1%] text-[#305658]">4. Sharing of Information</h2>
            <ul className="list-disc ml-[4%] space-y-[0.8%]">
              <li className="text-[2.7vw] font-sencondary text-[#305658] ">We do not sell or rent your information to third parties.</li>
              <li className="text-[2.7vw] font-sencondary text-[#305658]">Information may be shared with trusted service providers or contractors strictly for project execution purposes.</li>
              <li className="text-[2.7vw] font-sencondary text-[#305658]">Legal obligations may require disclosure of information if mandated by law.</li>
            </ul>
          </div>

          <div>
            <h2 className="font-bold text-[4vw] font-primary mb-[1%] text-[#305658]">5. Data Security</h2>
            <p className="text-[2.7vw] font-sencondary text-[#305658]">
              We implement reasonable technical and administrative measures to protect personal data. Access to personal information is restricted to authorized personnel only.
            </p>
          </div>

          <div>
            <h2 className="font-bold text-[4vw] text-[#305658] font-primary mb-[1%]">6. Cookies and Tracking</h2>
            <p className="text-[2.7vw] text-[#305658] font-sencondary ">
              Our website may use cookies to enhance user experience. Cookies do not collect personal information unless voluntarily provided.
            </p>
          </div>

          <div>
            <h2 className="font-bold text-[4vw] font-primary mb-[1%] text-[#305658]">7. User Rights</h2>
            <p className="text-[2.7vw] font-sencondary text-[#305658]">
              Users can request access, correction, or deletion of their personal information. Contact us at{" "}
              <Link href="https://mail.google.com/mail/u/0/?to=srivelamconstruction@gmail.com&su=Enquiry+Regarding+Construction+Services&fs=1&tf=cm"
                  target="_blank" className="text-green-700 font-c2a underline">
          ...
          <div>
            <h2 className="font-bold text-[4vw] font-primary mb-[1%] text-[#305658]">8. Updates to Privacy Policy</h2>
            <p className="text-[2.7vw font-sencondary text-[#305658]">
              We may update this privacy policy from time to time. Updated policies will be posted on our website with the effective date.
            </p>
          </div>
          ...
          <div>
            <h2 className="font-bold text-[4vw] font-primary mb-[1%] text-[#305658]">9. Contact</h2>
            <p className="text-[2.7vw] font-sencondary text-[#305658] ">For any questions regarding terms, conditions, or privacy, contact:</p>
            <p className="mt-[1%] font-semibold font-secondary text-[#305658]">SRI VELAN CONSTRUCTION</p>
            <p className="text-[2.7vw] font-sencondary text-[#305658]">Phone: 8248501872</p>
            <p className="text-[2.7vw] font-sencondary text-[#305658]">
              Email:{" "}
              <Link href="https://mail.google.com/mail/u/0/?to=srivelamconstruction@gmail.com&su=Enquiry+Regarding+Construction+Services&fs=1&tf=cm"
                  target="_blank" className="text-green-700 font-c2a underline">
      ...
      <div className="block md:hidden">
        <div className="bg-[#0c3c3f] text-center text-white py-[20%]">
          <h1 className="text-[7vw]  font-primary font-bold mb-2">Privacy Policy</h1>
        </div>

        <div className="max-w-3xl mx-auto px-[8%] py-[10%]  leading-[160%] space-y-[7%]">
          <div>
            <h2 className="font-bold text-[6vw] font-primary mb-[1%] text-[#063231]">1. Introduction</h2>
            <p className="text-[4vw] pt-[3%] font-sencondary text-[#305658] ">
              <span className="font-semibold text-[#063231] font-sencondary">SRI VELAN CONSTRUCTION</span> is committed to protecting the privacy of our clients and website users. This policy outlines how we collect, use, and safeguard your information.
            </p>
          </div>

          <div>
            <h2 className="font-bold text-[6vw] font-primary mb-[1%] text-[#063231] ">2. Information Collection</h2>
            <ul className="list-disc ml-[4%] space-y-[0.8%]">
              <li className="text-[4vw] font-sencondary text-[#305658]">Name, contact number, email address, and address.</li>
              <li className="text-[4vw] font-sencondary text-[#305658]">Project details, requirements, and preferences.</li>
            </ul>
          </div>

          <div>
            <h2 className="font-bold text-[6vw] font-primary mb-[1%] text-[#063231]">3. Use of Information</h2>
            <ul className="list-disc ml-[4%] space-y-[0.8%]">
              <li className="text-[4vw] font-sencondary text-[#305658]">Provide and improve our construction services.</li>
              <li className="text-[4vw] font-sencondary text-[#305658]">Respond to inquiries and service requests.</li>
              <li className="text-[4vw] font-sencondary text-[#305658]">Communicate project updates, billing, and contractual obligations.</li>
            </ul>
          </div>

          <div>
            <h2 className="font-bold text-[6vw] font-primary mb-[1%] text-[#063231]">4. Sharing of Information</h2>
            <ul className="list-disc ml-[4%] space-y-[0.8%]">
              <li className="text-[4vw] font-sencondary text-[#305658]">We do not sell or rent your information to third parties.</li>
              <li className="text-[4vw] font-sencondary text-[#305658]">Information may be shared with trusted service providers or contractors strictly for project execution purposes.</li>
              <li className="text-[4vw] font-sencondary text-[#305658]">Legal obligations may require disclosure of information if mandated by law.</li>
            </ul>
          </div>

          <div>
            <h2 className="font-bold text-[6vw] font-primary mb-[1%] text-[#063231]">5. Data Security</h2>
            <p className="text-[4vw] font-sencondary text-[#305658]">
              We implement reasonable technical and administrative measures to protect personal data. Access to personal information is restricted to authorized personnel only.
            </p>
          </div>

          <div>
            <h2 className="font-bold text-[6vw] font-primary mb-[1%] text-[#063231]">6. Cookies and Tracking</h2>
            <p className="text-[4vw] font-sencondary text-[#305658]">
              Our website may use cookies to enhance user experience. Cookies do not collect personal information unless voluntarily provided.
            </p>
          </div>
          ...
          <div>
            <h2 className="font-bold text-[6vw] font-primary mb-[1%] text-[#063231]">7. User Rights</h2>
            <p className="text-[4vw] font-sencondary  text-[#305658]">
              Users can request access, correction, or deletion of their personal information. Contact us at{" "}
              <Link href="https://mail.google.com/mail/u/0/?to=srivelamconstruction@gmail.com&su=Enquiry+Regarding+Construction+Services&fs=1&tf=cm"
                  target="_blank" className="text-green-700 font-c2a underline">
          ...
          <div>
            <h2 className="font-boldtext-[6vw] font-primary mb-[1%] text-[#063231]">8. Updates to Privacy Policy</h2>
            <p className="text-[4vw] font-sencondary text-[#305658]">
              We may update this privacy policy from time to time. Updated policies will be posted on our website with the effective date.
            </p>
          </div>
          ...
          <div>
            <h2 className="font-bold text-[6vw] font-primary mb-[1%] text-[#063231]">9. Contact</h2>
            <p className="text-[4vw] font-sencondary text-[#305658]">For any questions regarding terms, conditions, or privacy, contact:</p>
            <p className="mt-[1%] font-semibold font-secondary text-[#063231]">SRI VELAN CONSTRUCTION</p>
            <p className="text-[4vw] font-sencondary text-[#305658]">Phone: 8248501872</p>
            <p className="text-[4vw] font-sencondary text-[#305658]">
              Email:{" "}
              <Link href="https://mail.google.com/mail/u/0/?to=srivelamconstruction@gmail.com&su=Enquiry+Regarding+Construction+Services&fs=1&tf=cm"
                  target="_blank" className="text-green-700 font-c2a underline">
