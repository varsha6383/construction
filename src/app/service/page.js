      ...
      <div className="h-full w-full sm:hidden block  bg-white text-black">
        <div className="bg-[#218686] bg-blend-multiply rounded-bl-[80%_100px] rounded-br-[80%_100px] w-full h-[50vh] bg-cover bg-center bg-[url('https://images.pexels.com/photos/1396132/pexels-photo-1396132.jpeg')]">
          <div className="flex text-white items-center text-center gap-4 py-[30%] px-[5%] flex-col">
            <p className="bg-[#407d7d]/60  px-3 text-[100%] font-semibold py-1 rounded-full cursor-pointer font-c2a">
              SERVICES
            </p>
            <p className="font-bold text-[180%] font-primary">
              Our Construction Solutions
            </p>
            <p className="font-sencondary text-[100%]">
              We offer complete construction services to bring your dream home
              to life — with care, skill, and quality materials.
            </p>
          </div>
        ...
        <div className="flex flex-col gap-15 items-center px-[8%] my-10">
          <div className=" h-full justify-between w-full border  border-gray-400 rounded-3xl items-center">
            ...
            <div className="flex flex-col gap-3  p-5">
              ...
              <p className="font-bold text-[150%] pt-3 text-[#063231] font-primary ">
                Key Benefits
              </p>
              ...
              <button className="px-[5%] py-2 mt-4 text-[100%] rounded-full w-fit font-semibold tracking-wide text-[#063231] bg-[#cbff54] hover:bg-[#cffb69] cursor-pointer font-c2a">
                <Link href="/contact">ENQUIRE NOW</Link>
              </button>
            </div>
          </div>
          ...
          <div className=" h-full justify-between w-full border border-gray-400  rounded-3xl items-center">
            ...
            <div className="flex flex-col  gap-3 p-5">
              ...
              <button className="px-[5%] py-2 mt-4 text-[100%] rounded-full w-fit font-semibold tracking-wide text-[#063231] bg-[#cbff54] hover:bg-[#d0fb6b] cursor-pointer font-c2a">
                <Link href="/contact">ENQUIRE NOW</Link>
              </button>
            </div>
          </div>
          ...
          <div className=" h-full  justify-between w-full border border-gray-400  rounded-3xl items-center">
            ...
            <div className="flex flex-col gap-3 p-5">
              ...
              <button className="px-[5%] py-2 text-[100%] mt-4 rounded-full w-fit font-semibold tracking-wide text-[#063231] bg-[#cbff54] hover:bg-[#d0fc6a] cursor-pointer font-c2a">
                <Link href="/contact">ENQUIRE NOW</Link>
              </button>
            </div>
          </div>
        ...
        <div className=" h-full w-full bg-blue-50 py-10 px-[8%]">
          <div className="flex flex-col text-center   items-center gap-4 ">
            <p className="font-semibold text-[#305658] font-primary">
              3-STEP PROCESS
            </p>
            <p className="font-bold text-[200%] font-primary text-[#063231]">
              Our Process, Made Simple
            </p>
            <p className=" text-[#305658] font-sencondary text-[110%]">
              We believe that great homes are built through open communication
              and proper planning. Here’s how we make the process easy for you:
            </p>
          </div>
          ...
          <div className="grid grid-row-3 gap-5 items-center h-full w-full pt-10">
            <div className="flex flex-col gap-3 bg-white  shadow-2xl rounded-2xl items-center text-center p-5">
              ...
              <p className="font-bold text-[160%] text-[#063231] font-primary">
                1. Plan & Discover
              </p>
              <p className="font-sencondary text-[#305658] text-[110%]">
                We visit your site, understand your needs, and plan the right
            ...
            <div className="flex flex-col gap-3 bg-white text-[#305658] shadow-2xl rounded-2xl items-center text-center p-5">
              ...
              <p
                className="font-bold text-[160%] font-primary text-[#063231]
            "
              >
                3. Build & Deliver
              </p>
          ...
          <div className=" flex items-center justify-around p-10 text-center">
            <p className=" h-full text-[120%] tracking-widest text-[#305658] font-semibold bg-[#cbff54] cursor-pointer hover:bg-[#ccfa61]  px-3 py-2 rounded-full font-c2a">
              <Link href="/contact">Schedule a Free Consultation</Link>
            </p>
          </div>
        </div>
