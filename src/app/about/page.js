      ...
      <div className="hidden xl:block bg-white text-lg text-black">
        ...
        <div className="bg-[#137a7a]  items-center flex justify-center text-center bg-blend-multiply rounded-bl-[80%_100px] rounded-br-[80%_100px] w-full h-[70vh] bg-cover bg-center bg-[url('https://images.pexels.com/photos/2079234/pexels-photo-2079234.jpeg')]">
          <div className="flex text-white items-center text-center gap-4 py-[10%] px-[20%] flex-col">
            ...
            <p className="font-bold text-[3vw]   font-primary">Building With Care, Backed by Trust</p>
            <p className="font-sencondary text-[1.1vw]">At Sri Velan Constructions, we don’t just build houses — we build lasting relationships based on trust, honesty, and quality work.</p>
          </div>
        </div>
        ...
        <div className="flex flex-col w-full py-[5%]  px-[18%] bg-white">
          <div className="grid grid-cols-2 ">
            <p className="text-[2vw] font-bold text-[#063231]  font-primary">Built in Kambainallore. Trusted Across Dharmapuri.</p>
            <p className="font-sencondary text-[#305658] text-[1vw]">At Sri Velan Constructions, construction is more than cement and bricks — it’s about creating strong and comfortable homes that last for generations.
          ...
          <div className="grid grid-cols-3 grid-rows-2 py-20">
            <div className="flex flex-col justify-between h-[48vh] p-5 bg-[#0c3636] ">
              ...
              <div className="flex flex-col gap-5">
                <p className="font-bold text-[2.5vw]  text-[#cbff54] font-primary">100+</p><p className="text-white text-[1vw] font-sencondary">Completed multiple residential building projects in and around Dharmapuri with dedication and detail.</p>
              </div>
            </div>
            ...
            <div className="flex flex-col justify-between h-[48vh] p-5 bg-[#0c3636]">
              ...
              <div className="flex flex-col gap-5">
                <p className="font-bold text-[2.5vw]  text-[#cbff54] font-primary">3+ Families</p><p className="text-white text-[1vw] font-sencondary">Earned the trust of happy homeowners through honest work and clear communication.</p>
              </div>
            </div>
            ...
            <div className="flex flex-col justify-between h-[48vh] p-5 bg-[#cbff54]">
              ...
              <div className="flex flex-col gap-5">
                <p className="font-bold text-[2.5vw]  text-[#063231] font-primary">100% Effort</p><p className="font-sencondary text-[#063231] text-[1vw] ">Every project gets our full focus — from the first plan to the final finish.</p>
              </div>
            </div>
        ...
        <div className="flex  flex-col text-center px-[18%] py-[7%] bg-[#f6f7f7]">
          ...
          <p className="text-[2.8vw]  font-bold font-primary text-[#063231]">Vision, Mission & Values</p>
          <div className="grid grid-cols-3 grid-rows-1  justify-center gap-10 w-full h-full items-center px-[3%] pt-[8%]">
            ...
            <div className="flex flex-col gap-3 bg-white h-full shadow-2xl rounded-2xl items-center text-center p-10">
              ...
              <p className="font-bold text-[1.5vw] text-[#063231] font-primary">Our Vision</p>
              <p className="font-sencondary text-[1vw] text-[#305658]">To create safe, beautiful homes that bring happiness and pride to every family we serve.</p>
            </div>
            <div className="flex flex-col gap-3 bg-white shadow-2xl rounded-2xl items-center text-center p-10">
              ...
              <p className="font-bold text-[1.5vw] font-primary text-[#063231]">Our Mission</p>
              <p className="font-sencondary text-[1vw] text-[#305658]">To make construction simple and dependable through skilled work, open communication, and genuine care for clients. </p>
            </div>

            <div className="flex flex-col gap-3 bg-white h-full shadow-2xl rounded-2xl items-center text-center p-10">
<FaHandHoldingHeart size={44} color="#cbff54" className="rounded-full  p-1.5 bg-[#063231]"/>
              <p className="font-bold text-[1.5vw] font-primary text-[#063231]">Our Values</p>
              <p className="font-sencondary text-[1vw] text-[#305658]">We believe in integrity, responsibility, and quality. Every project is handled with respect for time, trust, and budget.</p>
            </div>
        ...
        <div className="grid grid-cols-2 gap-10 justify-between bg-white h-full w-full px-[18%] py-[7%]">
          ...
          <div className="flex flex-col gap-5 justify-center">
            <p className="font-primary text-[1.2vw] text-[#063231]">REAL FOUNDATION</p>
            <p className="font-bold text-[3vw]  font-primary text-[#063231]">What Drives Us</p>
            <p className="font-sencondary text-[1vw] text-[#305658]">We started Sri Velan Constructions with one goal — to bring reliability and quality back into local home construction.
            ...
            <div className="flex gap-2 pt-10 font-sencondary">
              ...
              <p className="font-sencondary text-[1vw] text-[#305658]">Experienced Local Builders</p>
            </div>

            <div className="flex gap-2 font-sencondary">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-circle-check-icon lucide-circle-check bg-black rounded-full "><path d="m9 12 2 2 4-6" /></svg>
              <p className="font-sencondary text-[1vw] text-[#305658]">Quality Materials & Neat Work</p>
            </div>
            ...
            <div className="flex gap-2 font-sencondary">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-circle-check-icon lucide-circle-check bg-black rounded-full "><path d="m9 12 2 2 4-6" /></svg>
              <p className="font-sencondary text-[1vw] text-[#305658]">Friendly and Honest Service</p>
            </div>
          </div>
        </div>
      </div>
...
{/* Desktop Responsive */}
      ...
      {/* Laptop Responsive */}
      <div className="hidden lg:block xl:hidden bg-white">

        <div className="bg-[#137a7a]  items-center flex justify-center text-center bg-blend-multiply rounded-bl-[80%_100px] rounded-br-[80%_100px] w-full h-[70vh] bg-cover bg-center bg-[url('https://images.pexels.com/photos/2079234/pexels-photo-2079234.jpeg')]">
          <div className="flex text-white items-center text-center gap-4 py-[10%] px-[20%] flex-col">
            <p className="bg-[#407d7d]/60 font-sencondary  px-3 font-semibold text-[1.5vw] py-1 rounded-full cursor-pointer">ABOUT</p>
            <p className="font-bold text-[4.5vw]  text-white font-primary">Building With Care, Backed by Trust</p>
            <p className="font-sencondary text-[1.7vw] text-white">At Sri Velan Constructions, we don’t just build houses — we build lasting relationships based on trust, honesty, and quality work.</p>
          </div>
        </div>
        ...
        <div className="flex flex-col w-full py-[4%]  px-[10%] bg-white">
          <div className="grid grid-cols-2 ">
            <p className="text-[2.4vw] font-bold  font-primary text-[#063231]">Built in Kambainallore. Trusted Across Dharmapuri.</p>
            <p className="font-sencondary text-[1.5vw] text-[#305658]">At Sri Velan Constructions, construction is more than cement and bricks — it’s about creating strong and comfortable homes that last for generations.
              Based in Kambainallore, Dharmapuri, we focus mainly on residential projects with a balance of quality, timing, and affordability.
              Our goal is simple: to make your dream home a reality through careful planning, reliable manpower, and transparent service.</p>
          </div>
          ...
          <div className="grid grid-cols-3 grid-rows-2 py-20">
            <div className="flex flex-col justify-between h-[48vh] p-5 bg-[#0c3636] ">
              <p className="font-semibold text-[#cbff54] text-[1.8vw] font-primary">PROJECTS</p>
              <div className="flex flex-col gap-5">
                <p className="font-bold text-[3vw] text-[#cbff54] font-primary ">100+</p><p className="text-white text-[1.5vw] font-sencondary">Completed multiple residential building projects in and around Dharmapuri with dedication and detail.</p>
              </div>
            </div>
            <Image src="https://images.pexels.com/photos/290275/pexels-photo-290275.jpeg" alt="Iimage is missing" height={400} width={400} className="h-[48vh] w-full"></Image>
            <div className="flex flex-col justify-between h-[48vh] p-5 bg-[#0c3636]">
              ...
              <div className="flex flex-col gap-5">
                <p className="font-bold text-[3vw] text-[#cbff54] font-primary">3+ Families</p><p className="text-white text-[1.5vw] font-sencondary">Earned the trust of happy homeowners through honest work and clear communication.</p>
              </div>
            </div>
            <Image src="https://images.pexels.com/photos/11916566/pexels-photo-11916566.jpeg" alt="Iimage is missing" height={400} width={400} className="h-[48vh] w-full"></Image>
            ...
            <div className="flex flex-col justify-between h-[48vh] p-5 bg-[#cbff54]">
              ...
              <div className="flex flex-col gap-5">
                <p className="font-bold text-[3vw] text-[#063231] font-primary">100% Effort</p><p className="font-sencondary text-[1.5vw] text-[#063231]">Every project gets our full focus — from the first plan to the final finish.</p>
              </div>
            </div>
            <Image src="https://images.pexels.com/photos/6320924/pexels-photo-6320924.jpeg" alt="Iimage is missing" height={400} width={400} className="h-[48vh] w-full"></Image>
        ...
        <div className="flex  flex-col text-center px-[10%] py-[7%] bg-[#f6f7f7]">
          <p className=" font-semibold text-[1.4vw] pb-5 font-primary text-[#305658]">IMPACTFUL</p>
          <p className="text-[3.5vw]  font-bold font-primary text-[#063231]">Vision, Mission & Values</p>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 justify-center items-stretch px-[3%] pt-[8%]">
  {/* Vision */}
  <div className="flex flex-col justify-between shadow-2xl rounded-2xl items-center text-center p-8 bg-white h-full">
    <div className="flex flex-col items-center gap-3">
      <div className="p-2 rounded-full bg-[#063231]">
        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#cbff54" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          <circle cx="12" cy="12" r="10" />
          <circle cx="12" cy="12" r="6" />
        </svg>
      </div>
      <p className="font-bold text-[2vw] font-primary text-[#063231]">Our Vision</p>
      <p className="font-secondary text-[1.5vw] leading-relaxed text-[#305658]">
  ...
  {/* Mission */}
  <div className="flex flex-col justify-between bg-white shadow-2xl rounded-2xl items-center text-center p-8 h-full">
    <div className="flex flex-col items-center gap-3">
      <div className="p-2 rounded-full bg-[#063231]">
        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="#cbff54" stroke="#cbff54" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          <path d="M4 22V4a1 1 0 0 1 .4-.8A6 6 0 0 1 8 2c3 0 5 2 7.333 2q2 0 3.067-.8A1 1 0 0 1 20 4v10a1 1 0 0 1-.4.8A6 6 0 0 1 16 16c-3 0-5-2-8-2a6 6 0 0 0-4 1.528" />
        </svg>
      </div>
      <p className="font-bold text-[2vw] font-primary text-[#063231]">Our Mission</p>
      <p className="font-secondary text-[1.5vw] leading-relaxed text-[#305658]">
  ...
  <div className="flex flex-col justify-between bg-white shadow-2xl rounded-2xl items-center text-center p-8 h-full">
    <div className="flex flex-col items-center gap-3">
      <div className="p-2 rounded-full bg-[#063231]">
       <FaHandHoldingHeart size={40} color="#cbff54" className="rounded-full  p-1 bg-[#063231]"/>

      </div>
      <p className="font-bold text-[2vw] font-primary text-[#063231]">Our Values</p>
      <p className="font-secondary text-[1.5vw] leading-relaxed text-[#305658]">
        ...
        <div className="grid grid-cols-2 gap-10 justify-between bg-white h-full w-full px-[12%] py-[7%]">
          ...
          <div className="flex flex-col gap-5 justify-center">
            <p className="font-primary text-[1.5vw] text-[#063231]">REAL FOUNDATION</p>
            <p className="font-bold text-[2.7vw]  font-primary text-[#063231]">What Drives Us</p>
            <p className="font-sencondary text-[1.5vw] text-[#305658]">We started Sri Velan Constructions with one goal — to bring reliability and quality back into local home construction.
              Our team focuses on clear communication, clean work, and long-term strength.
              From small houses to full family homes, we put our heart into every build.</p>
            <div className="flex gap-2 pt-10 font-sencondary">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-circle-check-icon lucide-circle-check bg-black rounded-full "><path d="m9 12 2 2 4-6" /></svg>
              <p className="font-sencondary text-[1.5vw] text-[#305658]">Experienced Local Builders</p>
            </div>

            <div className="flex gap-2 font-sencondary">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-circle-check-icon lucide-circle-check bg-black rounded-full "><path d="m9 12 2 2 4-6" /></svg>
              <p className="font-sencondary text-[1.5vw] text-[#305658]">Quality Materials & Neat Work</p>
            </div>
            ...
            <div className="flex gap-2 font-sencondary">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-circle-check-icon lucide-circle-check bg-black rounded-full "><path d="m9 12 2 2 4-6" /></svg>
              <p className="font-sencondary text-[1.5vw] text-[#305658]">Friendly and Honest Service</p>
            </div>
          </div>
        </div>
      </div>
