      ...
      <div className="sm:hidden block bg-white  text-[100%] text-black">
        <div className="bg-[#218686]  bg-blend-multiply rounded-bl-[80%_100px] rounded-br-[80%_100px] w-full h-[50vh] bg-cover bg-center bg-[url('https://images.pexels.com/photos/2079234/pexels-photo-2079234.jpeg')]">
          <div className="flex text-white items-center text-center gap-4 py-[20%]  px-[5%] flex-col">
            <p className="bg-[#407d7d]/60  px-3 font-semibold py-1 rounded-full text-[100%] cursor-pointer font-c2a">
              ABOUT
            </p>
            <p className="font-bold text-[7vw] font-primary text-white">
              Building With Care, Backed by Trust
            </p>
        ...
        <div className="flex flex-col  w-full py-[8%]  px-[8%] bg-white">
          <div className="grid grid-row-2  gap-[8%]">
            <p className="text-[180%] font-bold text-[#063231] font-primary">
              Built in Kambainallore. Trusted Across Dharmapuri.
            </p>
            <p className="pb-[5%] font-sencondary text-[#305658] text-[100%]">
              At Sri Velan Constructions, construction is more than cement and
              bricks — it’s about creating strong and comfortable homes that
              last for generations. Based in Kambainallore, Dharmapuri, we focus
              mainly on residential projects with a balance of quality, timing,
          ...
          <div className="grid-rows-6  py-[10%]">
            <div className="flex flex-col justify-between h-[28vh] p-5 bg-[#0c3636]">
              ...
              <div className="flex flex-col gap-5">
                <p className="font-bold text-[200%] text-[#cbff54] font-primary">
                  100+
                </p>
                <p className="text-white text-[90%] font-sencondary">
                  Completed multiple residential building projects in and around
                  Dharmapuri with dedication and detail.
                </p>
              </div>
            ...
            <div className="flex flex-col justify-between h-[28vh] p-5 bg-[#cbff54]">
              ...
              <div className="flex flex-col gap-5">
                <p className="font-bold text-[200%] text-[#063231] font-primary">
                  100% Effort
                </p>
                <p className="font-sencondary text-[#063231] text-[90%]">
                  Every project gets our full focus — from the first plan to the
                  final finish.
                </p>
              </div>
        ...
        <div className="flex  flex-col text-center px-[8%] py-[7%] bg-[#f6f7f7]">
          ...
          <p className="text-[170%] font-bold font-primary text-[#063231]">
            Vision, Mission & Values
          </p>
          <div className="grid grid-cols-1 grid-rows-3 gap-10 items-center pt-[8%]">
            <div className="flex flex-col gap-3 bg-white h-full shadow-2xl justify-center rounded-2xl items-center text-center p-[5%]">
              ...
              <p className="font-bold text-[150%] font-primary text-[#063231]">
                Our Vision
              </p>
        ...
        <div className="grid grid-cols-1 grid-rows-2 justify-between bg-white h-full w-full px-[8%] py-[7%]">
          ...
          <div className="flex flex-col gap-3 justify-center">
            <p className="font-primary text-[100%] text-[#063231]">
              REAL FOUNDATION
            </p>
            <p className="font-bold text-[170%] font-primary text-[#063231]">
              What Drives Us
            </p>
            <p className="font-sencondary text-[100%] text-[#305658]">
              We started Sri Velan Constructions with one goal — to bring
