  ...
  return (
    <main className="">
      ...
      <div className="hidden xl:block bg-white text-black">
        ...
        <div className="flex justify-center h-full items-center w-full bg-white my-20 ">
          <div className="flex flex-col gap-8 w-[35%] pr-[5%] ">
            <p className="font-semibold font-primary text-[1.1vw] text-[#305658]">
              We&apos;re Here to Help
            </p>
            <p className="font-bold text-[2.5vw] font-primary text-[#063231]">
        ...
        <div className="flex items-center flex-col w-full justify-center px-[8%] py-[8%] bg-[#f6f7f7]">
          ...
          <div className="grid grid-cols-3 items-center w-[80%] gap-8 justify-between h-full pt-[8%] ">
            <div className="flex flex-col h-full gap-3 bg-white shadow-2xl rounded-2xl items-center text-center p-6">
              <PiMapPinLineFill
                size={44}
                color="#cbff54"
                className="bg-[#063231] rounded-full p-2"
              />
            ...
            >
              <div className="flex flex-col gap-3 h-full bg-white shadow-2xl rounded-2xl items-center text-center p-10 ">
                <FaWhatsapp
                  size={44}
                  color="#cbff54"
                  className="bg-[#063231] rounded-full p-1.5"
                />
                <p className="font-bold text-[1.5vw] font-primary text-[#063231]">
                  Whatsapp
                </p>
            ...
            <div className="flex flex-col h-full gap-3 bg-white shadow-2xl rounded-2xl items-center text-center p-10">
              <TbLocation
                ...
                className="bg-[#063231] rounded-full p-2"
              />
              <p className="font-bold  font-primary text-[1.5vw] text-[#063231]">
                Follow us
              </p>
          ...
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m13!1m8!1m3!1d31196.87242333158!2d78.27674!3d12.206983!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMTLCsDEzJzA3LjQiTiA3OMKwMTcnMjguNCJF!5e0!3m2!1sta!2sin!4v1761208669450!5m2!1sta!2sin"
            width="600"
            height="600"
            className="border-0 w-[80%] overflow-hidden pt-[8%]"
            allowFullScreen=""
            loading="lazy"
      ...
      <div className="xl:hidden hidden lg:block bg-white text-black">
        ...
        <div className="flex justify-center gap-[8%] h-full items-center w-full  bg-white my-20 ">
          <div className="flex flex-col gap-[10%] w-[35%]  ">
            <p className="font-semibold text-[#305658] font-primary text-[1.8vw]">
              We&apos;re Here to Help
            </p>
        ...
        <div className="flex items-center flex-col w-full justify-center px-[10%] py-[8%] bg-[#f6f7f7]">
          <p className=" font-semibold font-primary text-[1.5vw] text-[#305658]">
            WE ARE HERE
          </p>
          ...
          <div className="grid grid-cols-3 items-center w-[100%] gap-8 justify-between h-full pt-[8%] ">
            <div className="flex flex-col h-full gap-3 bg-white shadow-2xl rounded-2xl items-center text-center p-6">
              <PiMapPinLineFill
                ...
                className="bg-[#063231] rounded-full p-2"
              />
              <p className="font-bold text-[2.2vw] font-primary text-[#063231]">
                Address
              </p>
              <p className="font-sencondary text-[1.5vw] text-[#305658]">
                Kambainallore, Dharmapuri, Tamil Nadu 635202
            ...
            <div className="flex flex-col h-full gap-3 bg-white shadow-2xl rounded-2xl items-center text-center p-10">
              <TbLocation
                ...
                className="bg-[#063231] rounded-full p-2"
              />
              <p className="font-bold  font-primary text-[2.2vw] text-[#063231]">
                Follow us
              </p>
              <div className="flex gap-5">
                <svg
          ...
          <iframe
            ...
            width="600"
            height="600"
            className="border-0 w-[100%] overflow-hidden pt-[8%]"
            allowFullScreen=""
            loading="lazy"
            referrerPolicy="no-referrer-when-downgrade"
          ></iframe>
      ...
      <div className="hidden sm:block lg:hidden bg-white">
        <div className="bg-[#218686] bg-blend-multiply rounded-bl-[80%_100px] rounded-br-[80%_100px] w-full h-[80%] bg-cover bg-center bg-[url('https://images.pexels.com/photos/2635038/pexels-photo-2635038.jpeg')]">
          <div className="flex text-white items-center text-center gap-4 py-[20%] px-[12%] flex-col">
            <p className="bg-[#407d7d]/60  px-3 font-semibold py-1 text-[2.5vw] rounded-full cursor-pointer font-primary">
              CONTACT
            </p>
        ...
        <div className="grid grid-rows-1 h-full gap-10 items-center  px-[8%] py-10 bg-white">
          <div className="flex flex-col gap-5 ">
            <p className="font-semibold text-[#305658] text-[2vw] font-primary">
              We&apos;re Here to Help
            </p>
        ...
        <div className="flex  flex-col text-center px-[8%] py-[8%] bg-[#f6f7f7]">
          <p className=" font-semibold text-[2vw] font-primary text-[#305658]">
            WE ARE HERE
          </p>
          <p className="text-[4.5vw] font-bold font-primary text-[#063231]">
            Find us on Google
          </p>
          <div className="grid grid-cols-1 grid-rows-4 gap-10 items-center h-full pt-[8%]">
            <div className="flex flex-col gap-3 bg-white shadow-lg h-full rounded-2xl items-center text-center p-10">
              <PiMapPinLineFill
                ...
                className="bg-[#063231] rounded-full p-2"
              />
              <p className="font-bold text-[3.5vw] font-primary text-[#063231]">
                Address
              </p>
              <p className="font-sencondary text-[2.5vw] text-[#305658]">
                Kambainallore, Dharmapuri, Tamil Nadu 635202
            ...
            <Link
              href="https://wa.me/918248501872"
              target="_blank"
              className="flex h-full flex-col gap-3 bg-white shadow-lg rounded-2xl items-center text-center p-10"
            >
            ...
            <div className="flex flex-col gap-3 bg-white shadow-lg h-full rounded-2xl items-center text-center p-10">
              ...
              <p className="font-sencondary text-[2.5vw] text-[#305658]">
                <Link
                  ...
                  className="font-secondary text-[110%] text-[#305658] hover:underline"
                >
                  +91 82485 01872
                </Link>
              </p>
      ...
      <div className="sm:hidden block bg-white">
        <div className="bg-[#218686] bg-blend-multiply rounded-bl-[80%_50px] rounded-br-[80%_50px] w-full h-[40vh] bg-cover bg-center bg-[url('https://images.pexels.com/photos/2635038/pexels-photo-2635038.jpeg')]">
          <div className="flex text-white items-center text-center gap-4 py-[20%] px-[6%] flex-col">
            <p className="bg-[#407d7d]/60 text-[4vw] px-3 font-semibold py-1 rounded-full cursor-pointer font-c2a">
              CONTACT
            </p>
            <p className="font-bold text-[7vw] font-primary ">
              Get in Touch with Sri Velan Constructions
            </p>
            <p className="font-sencondary text-[4vw] ">
              Reach out today to discuss your dream home or building project.
              We&apos;re here to help with a free consultation.
            </p>
          </div>
        ...
        <div className="grid grid-rows-1 h-full gap-10 items-center  px-[8%] py-10 bg-white">
          <div className="flex flex-col gap-5 ">
            <p className="font-semibold text-[#305658] font-primary text-[4vw]">
              We&apos;re Here to Help
            </p>
            <p className="font-bold text-[7vw] font-primary text-[#063231]">
              Let&apos;s Talk About Your Next Build!
            </p>
        ...
        <div className="flex  flex-col text-center h-full px-[8%] py-[8%] bg-[#f6f7f7]">
          <p className=" font-semibold text-[4vw] font-primary text-[#305658]">
            WE ARE HERE
          </p>
          <p className="text-[7vw] font-bold font-primary text-[#063231]">
            Find us on Google
          </p>
          <div className="grid grid-cols-1 grid-rows-6 gap-8 items-center w-full h-full pt-[8%]">
            <div className="flex flex-col gap-3 h-full bg-white shadow-lg rounded-2xl items-center text-center p-10">
              <PiMapPinLineFill
                ...
                className="bg-[#063231] rounded-full p-2"
              />
              <p className="font-bold text-[6.5vw] font-primary text-[#063231]">
                Address
              </p>
              <p className="font-sencondary text-[4vw] text-[#305658]">
                Kambainallore, Dharmapuri, Tamil Nadu 635202
            ...
            <div className="flex flex-col gap-3 bg-white shadow-lg h-full rounded-2xl items-center text-center p-10">
              ...
              <Link
                href="tel:+918248501872"
                className="font-secondary text-[4vw] text-[#305658] hover:underline"
              >
                +91 82485 01872
              </Link>
            </div>
