      ...
      <div className="hidden sm:block lg:hidden">
        <div className=" container  px-[8%]">
          ...
          <div className="flex flex-col  justify-between items-start  mb-12">
            <div>
              <p className="text-[2vw] font-semibold text-gray-500 uppercase mb-2 font-primary">
                OUR PROJECTS
              </p>
              <h2 className="text-[4.5vw] font-bold text-[#063231] leading-snug font-primary">
                Built to Last. Designed to Inspire.
              </h2>
            </div>

            <div className="my-6  text-gray-600">
              <p className="mb-4 text-[2.5vw] font-secondary">
                Every home we build is made to stand strong for generations,
                reflecting your dreams and our craftsmanship.
              </p>
              <button className="bg-[#cbff54] text-[#063231] text-[2.5vw] font-semibold py-3 px-6 rounded-full hover:bg-lime-500 transition font-c2a">
                <Link href="/projects">View Our Projects</Link>
              </button>
            </div>
          </div>
          ...
          {/* Image Grid */}
          <div className="mt-[10%] ">
            <div className=" w-[105%] h-[200px] overflow-hidden rounded-xl my-8">
              <Image
                src="https://images.pexels.com/photos/2901209/pexels-photo-2901209.jpeg"
                alt="Project 1"
                width={300}
        ...
        <div className="  gap-[20%] mt-[10%] py-[8%] w-full px-[10%] bg-[#899ca1] bg-blend-multiply  bg-cover bg-center bg-[url('https://images.pexels.com/photos/2635038/pexels-photo-2635038.jpeg')]">
          ...
          <div className="mt-10">
            <button className="bg-lime-300 border-dotted text-[2vw] border-white px-6 py-2 rounded-3xl text-[#063231] font-c2a">
              <Link href="/contact">ENQUIRE NOW</Link>
            </button>
          </div>
        </div>
      ...
      <div className="block sm:hidden ">
        <div className=" container  px-[8%] ">
          ...
          <div className="flex flex-col  justify-between items-start  mb-12">
            ...
            <div className="my-[6%] text-gray-600">
              <p className="mb-[5%] text-[4vw] font-secondary leading-relaxed">
                Every home we build is made to stand strong for generations,
                reflecting your dreams and our craftsmanship.
              </p>
              <button className="bg-[#cbff54] text-[#063231] font-semibold py-[3%] px-[6%] rounded-full hover:bg-lime-500 transition font-c2a text-[3.8vw]">
                <Link href="/projects">View Our Projects</Link>
              </button>
            </div>
          </div>
        ...
        <div className="  gap-[20%] mt-[10%] py-[8%] w-full px-6 bg-[#899ca1] bg-blend-multiply  bg-cover bg-center bg-[url('https://images.pexels.com/photos/2635038/pexels-photo-2635038.jpeg')]">
          ...
          <div className="mt-10">
            <button className="bg-lime-300 border-dotted text-[4vw] border-white px-6 py-2 rounded-3xl text-[#063231] font-c2a">
              <Link href="/contact">ENQUIRE NOW</Link>
            </button>
          </div>
        </div>
