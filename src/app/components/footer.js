...
{/* desktop responsive*/}
  ...
  <footer className="bg-[#0c3c3f] text-white pt-20 relative">
    ...
    <div className="max-w-9xl px-[10%] grid grid-cols-4 max-md:text-center  pb-16">
      ...
      <div>
        ...
        <div className="space-y-6 md:space-y-4 pl-4 md:pl-0 text-gray-300 text-[1.3vw]">
  ...
  <footer className="bg-[#0c3c3f] text-white pt-20 px-[5%] relative">
    ...
    <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 max-md:text-center gap-10 pb-16">
      ...
      {/* Left - Logo & About */}
      <div>
        <h3 className="text-[100%] font-semibold mb-3 text-left font-primary">
            {/* Logo */}
                    <Link href="/" onClick={closeMenu}>
          
                      <Image src="/sri_logo.png" alt="sri velan" width={120} height={400} />
                
                    </Link>
        </h3>
        <p className="text-gray-300 mb-5 text-left leading-relaxed font-secondary text-[2.5vw]">
          Your trusted construction partner in Dharmapuri, building strong homes with honest work and lasting results.
        </p>
        <div className="flex space-x-4">
          <div><FaFacebook size={20} color="#ffffff" className="cursor-pointer" /></div>
      ...
      <div className="flex gap-[20%]">
        {/* Company */}
        <div>
          <h4 className="text-[3vw] font-semibold mb-4 font-primary">Company</h4>
          <ul className="space-y-3 text-gray-300 text-left text-[2.5vw]">
            <li><Link href="/" className="hover:text-lime-400 font-c2a cursor-pointer">Home</Link></li>
            <li><Link href="/about" className="hover:text-lime-400 font-c2a cursor-pointer">About</Link></li>
            <li><Link href="/service" className="hover:text-lime-400 font-c2a cursor-pointer">Services</Link></li>
            <li><Link href="/projects" className="hover:text-lime-400 font-c2a cursor-pointer">Projects</Link></li>
        ...
        {/* Support */}
        <div>
          <h4 className="text-[3vw] font-semibold mb-4 font-primary">Support</h4>
          <ul className="space-y-2 text-gray-300 text-[2.5vw]">
            <li><Link href="/privacy" className="hover:text-lime-400 font-c2a cursor-pointer">Privacy Policy</Link></li>
            <li><Link href="/terms" className="hover:text-lime-400 font-c2a cursor-pointer">Terms & Conditions</Link></li>
          </ul>
        </div>
      ...
      {/* Contact Us */}
      <div>
        <h4 className="text-[3vw] font-semibold mb-4 text-left font-primary text-white">
          Company Info:
        </h4>

        <div className="space-y-6 text-[2.5vw]">
          {/* Phone */}
          <div className="flex gap-3 items-start">
            <div><FaPhoneAlt size={20} color="#ffffff" className="cursor-pointer mt-1" /></div>
            <div>
              <h1 className="font-c2a font-bold text-gray-300 text-[2.5vw]">Call Us</h1>
              <h1 className="text-gray-300 text-[2vw]">+91 82485 01872</h1>
            </div>
          </div>
          ...
          <div className="flex gap-3 items-start">
            <div><IoMdMail size={20} color="#ffffff" className="cursor-pointer mt-1" /></div>
            <div>
              <h1 className="font-c2a font-bold text-gray-300 text-[2.5vw]">Send Email</h1>
              <h1>
                <Link
                  href="https://mail.google.com/mail/u/0/?to=srivelamconstruction@gmail.com&su=Enquiry+Regarding+Construction+Services&fs=1&tf=cm"
                  target="_blank"
                  className="text-[2vw] text-gray-300 underline hover:text-green-800 transition-colors"
                >
                  srivelamconstruction@gmail.com
                </Link>
              </h1>
          ...
          <div className="flex gap-3 items-start">
            <div><FaLocationArrow size={20} color="#ffffff" className="cursor-pointer mt-1" /></div>
            <div>
              <h1 className="font-c2a font-bold text-gray-300 text-[2.5vw]">Address</h1>
              <h1 className="text-gray-300 text-[2vw]">Kambainallore, Dharmapuri</h1>
            </div>
          </div>
        </div>
      </div>
    ...
    {/* Bottom Border */}
    <div className="border-t border-gray-600 text-center py-6 text-gray-400 text-[2vw] font-c2a">
      © {new Date().getFullYear()} All rights reserved.
 ...
 {/* mobile responsive */}
  ...
  <footer className="bg-[#0c3c3f] text-white pt-20 px-[5%] relative">
    ...
    <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 max-md:text-center gap-10 pb-16">
        ...
        <h3 className=" font-semibold mb-3 text-left font-primary">
            {/* Logo */}
                    <Link href="/" onClick={closeMenu}>
                      ...
                      <Image src="/sri_logo.png" alt="sri velan" width={100} height={400} />
      ...
      {/* Contact Us */}
      <div>
        <h4 className="text-[4.5vw] font-semibold mb-4 text-left font-primary text-white">
          Company Info:
        </h4>

        <div className="space-y-6 text-[3.5vw]">
          {/* Phone */}
          <div className="flex gap-3 items-start">
            <div><FaPhoneAlt size={20} color="#ffffff" className="cursor-pointer mt-1" /></div>
            <div>
