...
export default function Footer() {
  ...
  <footer className="bg-[#0c3c3f] text-white pt-20 relative">
    {/* 🔹 Main Footer */}
    <div className="max-w-7xl px-[10%] mx-auto grid grid-cols-1 md:grid-cols-4 max-md:text-center gap-10 pb-16">
      ...
      <div className="lg:ml-[20%]">
        ...
        <ul className="space-y-3 text-gray-300 text-[100%]">
      ...
      {/* Contact Us */}
      <div>
        <h4 className="text-[120%] font-semibold mb-4 font-primary text-white">Company Info:</h4>

        <div className="space-y-6 md:space-y-4 pl-4 md:pl-0 text-gray-300 text-[100%]">

          {/* Phone / WhatsApp */}
          <div className="flex items-start gap-3">
            <div><FaPhoneAlt size={20} color="#ffffff" className="cursor-pointer mt-1" /></div>
            <div>
              <h1 className="font-c2a font-bold text-[100%]">Call Us</h1>
              <h1>
                <Link
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <h1 className="font-c2a font-bold text-[100%]">Send Email</h1>
              <h1>
                <Link
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <h1 className="font-c2a font-bold text-[100%]">Address</h1>
  ...
  <footer className="bg-[#0c3c3f] text-white pt-20 relative">
    {/* 🔹 Main Footer */}
    <div className="w-full pr-[12%] pl-[9%] grid grid-cols-4 max-md:text-center gap-4 pb-16">
